...
%% Model
function [steady_states] = simulate_selvaggio(intra_h2o2, v_sup, cell_type)
...
initvals = [init_h2o2; 0.01; 0.01; 0.001; 0.01;  0.01; 0.001; 0.01; 0.01];
...
steady_states = sol(idx,7)/Params.PrxIITotal; % PrxIISS
end